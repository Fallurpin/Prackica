function showMessage() {
 ...
 // alert(message);  Ошибка
  ...
  const user1 = new User("Дмитрий");
  user1.displayUserName(); // Имя пользователя: Дмитрий
  ...
  const greeter = new Greeter('Дмитрий');//Привет Дмитрий
  greeter.showMessage();
  ...
  const reverser = new NameReverser("Дмитрий");
  console.log(reverser.reverseName()); // йитримД вонримС